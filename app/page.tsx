            ...
            <div className="bg-white max-w-[396px] rounded-lg flex flex-col items-center justify-end gap-4 px-4 py-3 transform transition-transform duration-300 ease-in-out hover:-translate-y-2 hover:drop-shadow-xl lg:items-start">
              <div className="flex justify-between w-full">
                ...
                <svg width="36" height="36" viewBox="0 0 36 36" fill="none" xmlns="http://www.w3.org/2000/svg">
                  ...
                  <path fillRule="evenodd" clipRule="evenodd" d="M17.3799 23.417C24.0616 23.417 26.9922 19.0212 22.0688 14.9184C23.5927 20.0762 19.5485 19.8417 17.3799 19.9003V17.9076L13.1013 21.6587L17.3799 25.4098V23.417Z" fill="#26B11A" />
                  <path fillRule="evenodd" clipRule="evenodd" d="M18.3177 11.1673C11.636 11.1673 8.70547 15.5631 13.6288 19.6073C12.1049 14.5081 16.1491 14.7426 18.3177 14.684V16.6181L22.5963 12.9256L18.3177 9.17453V11.1673Z" fill="#26B11A" />
                </svg>
              </div>
              <div className="flex flex-col gap-2 lg:gap-4">
